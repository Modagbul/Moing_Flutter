...
import 'package:moing_flutter/login/date/component/const/custom_constants.dart';
import 'package:moing_flutter/login/date/component/custom_date_picker_options.dart';
import 'package:moing_flutter/login/date/component/custom_date_picker_scroll_view_options.dart';
import 'package:moing_flutter/login/date/component/custom_date_scroll_view.dart';
import 'package:moing_flutter/login/date/component/const/custom_get_monthly_date.dart';
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        widget.options.backgroundColor.withOpacity(0.8),
                        widget.options.backgroundColor.withOpacity(0.3),
                      ],
                    ),
                  ),
                ),
